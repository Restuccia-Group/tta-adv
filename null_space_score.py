...
def null_space_projection(model, layers, data_loader, feat_src_1, feat_src_2, 
    ...
    for n_batch, (inputs,labels) in enumerate(bar):
        ...
        feat_test = activations_src['layer3.1.conv1']
        ...
        scores_null_1 = torch.cat((scores_null_1, torch.cdist(projection_1, proj_cls_k1)), dim=0)
        scores_null_2 = torch.cat((scores_null_2, torch.cdist(projection_2, proj_cls_k2)), dim=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--loss', type=str,help="Specify the loss to be used by fca" )
    ...
    activations, labels = log_activation_src(model, ['layer3.1.conv1','layer3.2.conv2'], src_data_loader, device)
    
    feat_src_1 = activations['layer3.1.conv1']
    K_1 = RBF_kernel(feat_src_1, feat_src_1)
    feat_src_2 = activations['layer3.2.conv2']
    ...
    for corruption in corruptions:
        ...
        scores_1, scores_2 = null_space_projection(model, ['layer3.1.conv1','layer3.2.conv2'], data_loader, feat_src_1, feat_src_2,
